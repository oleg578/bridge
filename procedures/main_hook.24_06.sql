...
`Attribute4Name` = 'D_SHIPPMENT_TYPE';
...
### SET D_SHIPPMENT_TYPE ###
UPDATE
temp_ca_push
SET `Attribute4Value` =
(SELECT attribute.`Value` FROM attribute WHERE attribute.Sku = `Inventory Number` AND attribute.`Name` = 'D_SHIPPMENT_TYPE' Limit 1);

### DEFUALTS D_SHIPPMENT_TYPE ###
UPDATE temp_ca_push SET `Attribute4Value` = 'NLA' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = '509' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'NLA' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = '8TEN' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'STOCKED ITEM' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'BD' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'STOCKED ITEM' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'BRP' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'NLA' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'FXR' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'STOCKED ITEM' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'HUS' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'STOCKED ITEM' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'MTD' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'STOCKED ITEM' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'ORC' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'STOCKED ITEM' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'POL' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'STOCKED ITEM' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'PRO' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'STOCKED ITEM' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'RM' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'STOCKED ITEM' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'SG' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = 'STOCKED ITEM' WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'WPS' AND `Attribute4Value` = '';
UPDATE temp_ca_push SET `Attribute4Value` = NULL WHERE SUBSTRING_INDEX(`Inventory Number`,'_',1) = 'KIT' AND `Attribute4Value` = '';

### POLARIS NLA ITEMS ###
UPDATE temp_ca_push SET Attribute4Value = 'NLA' WHERE `Inventory Number` = (
SELECT
product.Sku
FROM
product
WHERE
product.Sku NOT IN ( SELECT pricefile.sku_custom FROM inventroy.pricefile) AND
product.Sku NOT LIKE 'GHOST SKU WORKAROUND%' AND
product.SupplierCode = 'POL' AND
product.Sku NOT LIKE '%GHOST%' AND
product.Sku NOT LIKE '%KIT%'
LIMIT 1);
