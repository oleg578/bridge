...
class ControllerBase extends \Phalcon\Mvc\Controller
{
    ...
    public function initialize()
    {
        ...
        $this->assets
             ...
             ->addCss('https://fonts.googleapis.com/css?family=Roboto+Condensed|Roboto:700,900,900i', false, false, [
                'as' => 'style',
            ])
             ->addCss('https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css', false, false, [
                 'as' => 'style',
             ]);
        $this->assets
             ->collection('footer_js')
             ->setTargetPath('assets/js/ext/scripts.js')
             ->setTargetUri('assets/js/ext/scripts.js')
             ->addJs('assets/js/ext/jquery.min.js')
             ->addJs('assets/js/ext/bootstrap.min.js')
