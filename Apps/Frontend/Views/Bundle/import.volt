...
<div layout-padding>
    ...
    <div class="alert alert-danger" role="alert"><h4>CABUNDLE is in progress now...</h4></div>
</div>
{% endif %}
{% if not psfound %}
<div layout-padding>
    <h4 class="orange-color">Import Bundles</h4>
...
<div class="zip-bundle-error-wrapper ng-hide">
    <div class="alert alert-danger alert-dismissible zip-bundle-dir-error" role="alert">
        <button type="button" class="close" id="zip-bundle-error-btn"><span aria-hidden="true">&times;</span></button>
...
<div class="zip-bundle-dir-error-wrapper ng-hide">
    <div class="alert alert-danger alert-dismissible zip-bundle-error" role="alert">
        <button type="button" class="close" id="zip-bundle-dir-error-btn"><span aria-hidden="true">&times;</span></button>
